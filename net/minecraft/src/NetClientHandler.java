...
public class NetClientHandler extends NetHandler
{
    ...
    public void handleHandshake(Packet2Handshake packet2handshake)
    {
        ...
        {
            addToSendQueue(new Packet1Login(mc.session.username, "Password", 10));
        } else
        {
            try
            {
    ...
    {
        mc.thePlayer.func_25061_a(new ChunkCoordinates(packet6spawnposition.xPosition, packet6spawnposition.yPosition, packet6spawnposition.zPosition));
    }
    ...
    public void func_25118_a(Packet70 packet70)
    {
        int i = packet70.field_25019_b;
        if(i >= 0 && i < Packet70.field_25020_a.length)
        {
            mc.thePlayer.addChatMessage(Packet70.field_25020_a[i]);
        }
    }
