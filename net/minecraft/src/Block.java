...
public class Block
{
    ...
    public static final Block piwoBlock;
    public static final Block szesciopakBlock;
    ...
    static 
    {
        ...
        field_25017_bj = (new BlockLockedChest(95)).setHardness(-1F).setLightValue(1.0F).setStepSound(soundWoodFootstep).setBlockName("lockedchest");
        piwoBlock = (new BlockPiwo(255, 54)).setHardness(0.5F).setStepSound(soundMetalFootstep).setBlockName("piwo");
        szesciopakBlock = (new BlockSzesciopak(254, 109)).setHardness(0.5F).setStepSound(soundMetalFootstep).setBlockName("szesciopak");
