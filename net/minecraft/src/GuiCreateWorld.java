...
public class GuiCreateWorld extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        textboxWorldName = new GuiDisableButton(fontRenderer, width / 2 - 100, 60, 200, 20, stringtranslate.translateKey("selectWorld.newWorld"));
        textboxWorldName.isFocused = true;
        textboxWorldName.setMaxStringLength(32);
        textboxSeed = new GuiDisableButton(fontRenderer, width / 2 - 100, 116, 200, 20, "");
        func_22129_j();
    }
