...
public abstract class EntityLiving extends Entity
{
    ...
    public int getMinimumLivingSoundHoldoffTime()
    {
        return 80;
    }
    ...
    public void onEntityUpdate()
    {
        ...
        if(rand.nextInt(1000) < liveSpewCounter++)
        {
            liveSpewCounter = -getMinimumLivingSoundHoldoffTime();
            playLivingSound();
        }
        if(isEntityAlive() && isEntityInsideBlock())
        {
    ...
    protected void updatePlayerActionState()
    {
        ...
        if(func_25023_u() && entityplayer != null)
        {
        ...
        {
            faceEntity(field_4120_b, 10F, func_25026_x());
