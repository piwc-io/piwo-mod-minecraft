            ...
            } else
            {
                ...
                if(slot != null)
                {
                    ...
                    if(itemstack2 == null)
                    {
                        ...
                        if(itemstack4 != null && slot.func_25014_f())
                        {
                            entityplayer.func_25058_a(StatList.field_25158_z[itemstack4.itemID], itemstack4.stackSize);
                        }
                    ...
                    if(itemstack1.itemID == itemstack2.itemID && itemstack2.getMaxStackSize() > 1 && (!itemstack1.getHasSubtypes() || itemstack1.getItemDamage() == itemstack2.getItemDamage()))
                    {
                        ...
                        if(j1 > 0 && j1 + itemstack2.stackSize <= itemstack2.getMaxStackSize())
                        {
                            ...
                            {
                                entityplayer.func_25058_a(StatList.field_25158_z[itemstack5.itemID], itemstack5.stackSize);
                            }
                            if(itemstack1.stackSize == 0)
                            {
                                slot.putStack(null);
